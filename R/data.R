...
#'   \item{n_Averaged}{}
#'   \item{Boxcar}{}
#'   \item{CorrElectricDark}{}
#'   \item{StrobeLampEnabled}{}
#'   \item{CorrDetectorNonLin}{}
#'   \item{CorrStrayLight}{}
#'   \item{n_Pixels}{}
#' }
#' @source \url{https://doi.org/10.1021/acs.jpcc.9b11229}
#' @source \url{https://solarchemist.se/2021/08/02/composite-gif-gganimate/}
"UVVisDataZnO"
